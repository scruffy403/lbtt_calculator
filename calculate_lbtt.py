...
def calcultate_lbtt_previous_buyer(property_value):
    price_bands = [PurchasePriceBands(0, 145000, 0), PurchasePriceBands(145001, 250000, 0.02), PurchasePriceBands(250001, 325000, 0.06), PurchasePriceBands(325001, 750000, 0.10), PurchasePriceBands(750001, float(inf), 0.12)]
    bands = []
    tax = 0
